...
const ProductCategory = () => {
  ...
  const filteredCategories = categories.filter(category => {
    ...
    const matchesFilter = 
      categoryFilter === 'all' || category._id === categoryFilter;
          ...
          <div className="flex justify-between items-center mb-6">
            <div className="text-sm text-gray-600">
              {categoryFilter === 'all' ? 'Showing all categories' : 
                `Showing: ${categories.find(c => c._id === categoryFilter)?.name}`}
            </div>
            <button
                  ...
                  renderRow={(category, index) => (
                    ...
                    >
                      <td className="py-4 px-4">
                        <div className="font-medium text-black text-lg capitalize">{category.name}</div>
                      </td>
                      <td className="py-4 px-4">
