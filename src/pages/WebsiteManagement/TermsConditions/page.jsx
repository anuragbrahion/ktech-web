...
export default function TermsAnDCon() {
  const [formData, setFormData] = useState({
    heading: '<h1>Terms and Conditions</h1>',
      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-200">
          <div className="flex items-center justify-between mb-10">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Terms and Conditions Editor</h1>
              <p className="text-gray-600 mt-2">Customize your Terms and Conditions page content</p>
            </div>
            <button
