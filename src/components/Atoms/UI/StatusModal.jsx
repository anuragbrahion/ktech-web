...
const StatusModal = ({ isOpen, onClose, statusData, mode, onSubmit }) => {
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-md my-8">
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">
            {mode === 'add' ? 'Add Status' : 'Update your status details'}
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end space-x-3 pt-6 border-t">
              ...
              >
                {mode === 'add' ? 'Create Status' : 'Update Status'}
              </button>
            </div>
          </form>
        </div>
