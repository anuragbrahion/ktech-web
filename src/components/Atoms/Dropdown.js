    ...
    <div className={`relative w-full ${mainClassName}`}>
      ...
      <div className={`relative  ${className}`}>
        <select
          ...
          disabled={disabled}
          className={`w-full appearance-none p-2 border border-[#D8D8D8] bg-white rounded-[40px] text-sm text-[#212121]
            focus:outline-none focus:ring-0 focus:border-[#D8D8D8] pl-4 overflow-y-auto `}
          isMulti
